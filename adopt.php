                    ...
                    <form action="" id="search-form">
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input style="border: 2px solid grey;" type="text" class="form-control" id="search-filter" placeholder="Please search here..">
                            </div>
                        </div>
                    ...
                    <form id="filter-form">
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <select style="border: 2px solid grey;" class="form-select" id="type-filter">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input style="border: 2px solid grey;" type="text" class="form-control" id="breed-filter" placeholder="Enter breed">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="age-filter" class="form-label">Age (years):</label>
                                <div class="input-group">
                                    <select style="border: 2px solid grey;" class="form-control" id="age-filter">
